...
Version: 1.0.0
Author: Least Common Denominator Calculator / www.calculator.io
...
if (!function_exists('add_shortcode')) return "No direct call for Least Common Denominator Calculator by www.calculator.io";

function display_calcio_ci_lcd_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_lcd_calculator', 'display_calcio_ci_lcd_calculator' );